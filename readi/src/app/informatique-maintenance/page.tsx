      ...
      <section className="relative min-h-[50vh] md:h-[40vh] md:min-h-[400px] flex items-center justify-center overflow-hidden bg-emerald-900 py-20 md:py-0">
        ...
        <div className="container relative z-20 mx-auto px-4 text-center text-white">
          ...
          <div className="animate-in fade-in zoom-in-95 duration-1000">
            <Button asChild size="lg" className="bg-white text-emerald-600 hover:bg-emerald-50 h-auto min-h-[3.5rem] py-4 px-6 md:px-8 rounded-2xl font-black shadow-xl transition-all hover:scale-105 active:scale-95 text-base md:text-lg whitespace-normal text-center leading-tight">
