    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-2xl font-bold text-white mb-4">
              READI<span className="text-red-500">.FR</span>
            </h3>
            <p className="text-sm mb-4">
              Pro depuis 1994. Votre partenaire informatique de confiance pour l&apos;affichage dynamique, 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm">
                ...
                <span>123 Rue de l&apos;Informatique<br />76000 Rouen, France</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <p>&copy; {new Date().getFullYear()} READI.FR - Tous droits réservés.</p>
